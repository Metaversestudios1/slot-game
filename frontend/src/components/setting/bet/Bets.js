  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center">
        <div className="text-2xl font-bold mx-2 my-8 px-4">Bets List</div>
      </div>
      <div className="flex justify-between">
        <NavLink to="/bets/addbet">
              ...
              {bets.map((item, index) => (
                <tr key={item?._id} className="bg-white">
                  ...
                  <td className=" py-5 pl-5 gap-1 border-2  border-gray-300">
                    <div className="flex items-center">
                      <NavLink to={`/bets/editbet/${item?._id}`}>
      ...
      {noData && (
        <div className="text-center text-xl">
          Currently! There are no bets in the storage.
        </div>
      )}
        ...
        <div className="flex flex-col items-center my-10">
          ...
          <div className="inline-flex mt-2 xs:mt-0">
            ...
            <button
              onClick={() => setPage(page + 1)}
              disabled={
                bets.length < pageSize || startIndex + pageSize >= count
              }
